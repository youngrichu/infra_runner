...
export class ObstacleManager {
    ...
    createObstacle(playerZ) {
        ...
        this.obstacles.push({ mesh: obstacleMesh, type: type, boundingBox: new THREE.Box3(), hasCollided: false });
    ...
    checkCollisions(playerBox, waterSlideObjects, hasWaterSlide) {
        ...
        for (let i = 0; i < this.obstacles.length; i++) {
            if (this.obstacles[i].hasCollided) continue;
            ...
            if (!isProtectedByWaterSlide && collisionDetected) {
                ...
                this.obstacles[i].hasCollided = true;
                return true;
            }
        }
        return false;
